...
export default function SignupScreen() {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      // If email confirmation is enabled there's no session yet; otherwise the
      // root navigator redirects on the new session.
    ...
    <SafeAreaView className="flex-1 bg-neutral-950">
      ...
      >
        ...
        <Text className="mb-8 text-base text-neutral-400">
          Track movies and TV across web and mobile.
        </Text>
        ...
        {message ? (
          <Text className="mb-2 text-sm text-green-400">{message}</Text>
        ) : null}
